...
Both ceil_log2 and ceil_log2(x+1) (called NOAHZK_min_bitcnt_var for the uint64_t version and NOAHZK_variable_width_min_bitcnt for the variable width type version) use GCC's __builtin* family of functions.
