...
void* NOAHZK_init_variable_width_var_arr(struct NOAHZK_variable_width_var* toinit, void* arr, const uint64_t width_in_bytes){
    if(!toinit) toinit = malloc(sizeof(struct NOAHZK_variable_width_var));
...
void* NOAHZK_copy_variable_width_var_to_arr(void* dst, uint64_t width_dst, struct NOAHZK_variable_width_var* src){
